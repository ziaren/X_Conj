...
# List all csv files
Raw_ex2_an_gp1  <- read_csv("Raw_ex2-an-gp1.csv")
Raw_ex2_an_gp2  <- read_csv("Raw_ex2-an-gp2.csv")
Raw_ex2_an_gp3  <- read_csv("Raw_ex2-an-gp3.csv")
Raw_ex2_an_gp4  <- read_csv("Raw_ex2-an-gp4.csv")
Raw_ex2_an_gp5  <- read_csv("Raw_ex2-an-gp5.csv")
Raw_ex2_an_gp6  <- read_csv("Raw_ex2-an-gp6.csv")

Template_ex2_gp1 <- read_csv("Template_ex2-gp1.csv")
Template_ex2_gp2 <- read_csv("Template_ex2-gp2.csv")
Template_ex2_gp3 <- read_csv("Template_ex2-gp3.csv")
Template_ex2_gp4 <- read_csv("Template_ex2-gp4.csv")
Template_ex2_gp5 <- read_csv("Template_ex2-gp5.csv")
Template_ex2_gp6 <- read_csv("Template_ex2-gp6.csv")
...
Raw_ex2_an_gp1 <- raw_list_clean[[1]]
Raw_ex2_an_gp2 <- raw_list_clean[[2]]
Raw_ex2_an_gp3 <- raw_list_clean[[3]]
Raw_ex2_an_gp4 <- raw_list_clean[[4]]
Raw_ex2_an_gp5 <- raw_list_clean[[5]]
Raw_ex2_an_gp6 <- raw_list_clean[[6]]

for (i in 1:6) {
  df_name <- paste0("Raw_ex2_an_gp", i)
  df <- get(df_name)
...
for (i in 1:6) {
  ...
  df_name <- paste0("Template_ex2_gp", i)
  df <- get(df_name)
...
for (i in 1:6) {
  ...
  raw_name <- paste0("Raw_ex2_an_gp", i, "_long")
  template_name <- paste0("Template_ex2_gp", i)
...
library(readr)
write_csv(ex2_cleaned, "ex2_cleaned.csv")
